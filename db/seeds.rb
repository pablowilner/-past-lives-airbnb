...
character_two = Character.new(name: "Napoleon Bonaparte", user: user, title: "The French Revolution (1789)", description: "One of the most celebrated personages in the history of the West. He revolutionized military organization and training; sponsored the Napoleonic Code, the prototype of later civil-law codes; reorganized education; and established the long-lived Concordat with the papacy.",
...
character_four = Character.new(name: "Maradona", user: user, title: "The off-field life - Sex, Drugs & Football", description: "Live the exciting and troubled off-field life of Maradona during the 90's when he ended up banned from the field for abusing drugs.",
...
character_five = Character.new(name: "Frida Khalo", user: user, title: "International Recognition of the Artist", description: "Live the exciting and troubled off-field life of Maradona during the 90's when he ended up banned from the field for abusing drugs.",
  price: 700, historical_period: "Contemporary History (1900 Present)", profession: "artist", address: "Coyoacan, Ciudad de Maxico, Maxico")
...
character_six = Character.new(name: "Billy The Kid", user: user,  title: "Last Jailbreak", description: "In spring of  1881, toward the end of the Lincoln County War, William Bonney was jailed in Lincoln,  having been tried for the murder of Sheriff William Brady.  He would escape one last time from the courthouse jail on April 28th, killing Deputies JW Bell and R. Olinger on his way. ",
